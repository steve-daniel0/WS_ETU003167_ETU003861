INSERT INTO student (id, name, first_name, birth, student_code) VALUES
(1, 'Smith', 'John', '2002-05-10', 'ETU001'),
(2, 'Johnson', 'Emma', '2001-08-20', 'ETU002');

INSERT INTO semester (id, label, year) VALUES
(1, 'Semester 1', 1),
(2, 'Semester 2', 1),
(3, 'Semester 3', 2),
(4, 'Semester 4', 2);

INSERT INTO academic_year (id, date_start, date_end) VALUES
(1, '2024-01-01', '2024-12-31'),
(2, '2025-01-01', '2025-12-31');

INSERT INTO subject (id, name, ue) VALUES
(1, 'Mathematics I', 'UE1'),
...
INSERT INTO student_option (id, label) VALUES
(1, 'dev'),
(2, 'web'),
(3, 'db');

INSERT INTO semester_year (id, semester_id, academic_year_id, date_start, date_end) VALUES
...
-- Semester 1
INSERT INTO semester_subject (id, semester_id, subject_id, option_id, credit) VALUES
(1, 1, 1, NULL, 4),
(2, 1, 2, NULL, 4),
(3, 1, 3, NULL, 2);
...
INSERT INTO semester_subject (id, semester_id, subject_id, option_id, credit) VALUES
(10, 4, 10, 1, 4),  -- Web Dev → dev option
(11, 4, 11, 2, 4),  -- Mobile Dev → web option
(12, 4, 12, 3, 4);  -- DB optimization → db option

INSERT INTO student_semester (id, student_id, semester_year_id, registration_date) VALUES
(1, 1, 1, '2024-02-01'),
(2, 1, 2, '2024-07-01'),
(3, 1, 3, '2025-02-01'),
(4, 1, 4, '2025-07-01'),
...
INSERT INTO exam_session (id, date) VALUES
(1, '2024-06-20'),
(2, '2024-12-10'),
(3, '2025-06-20'),
(4, '2025-12-10');
